    ...
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm
            ...
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                <button className='bg-blue-600 w-full text-white py-2 rounded-full transition duration-300 
              ease-in-out hover:scale-104 hover:bg-blue-500 cursor-pointer'>
                ...
                <img onClick={() => setShowLogin(false)} src={assets.cross_icon} alt=""
                    className='absolute top-5 right-5 cursor-pointer ease-in-out hover:scale-104 hover:bg-gray-500' />
            </form>
        </div>
    );
};
